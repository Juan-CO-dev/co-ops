...
export function renderMagicLinkEmail(args: { link: string }): string {
  return renderEmailLayout({
    preheader: "Your sign-in link for Compliments Only — valid for 30 minutes.",
    heading: "Sign in to your catering order",
    bodyHtml: `
      <p style="margin:0;">Tap the button below to sign in to Compliments Only and pick up right where you left off. This link works once and expires in 30 minutes.</p>
    `,
