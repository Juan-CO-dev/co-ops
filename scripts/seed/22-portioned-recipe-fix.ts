...
import {
  ...
  type TrimEvidence,
  type TrimStandard,
} from "@/lib/trim-standards-shared";
...
//
// LIFTED to lib/trim-standards-shared.ts (deviation D11 of the 2026-08-20 product-
// identity plan). It used to live here as a const this script exported nothing of,
// which meant the weight & trim board had no importable "standard" to compare an
// observation against. The numbers, the evidence grades and every rationale string
// are unchanged — they simply have one home now, and this script reads it.
//
// The five classes and the reasoning behind each are documented in that module.
