 ...
 *
 *   SEED_DRY=1 npx tsx --conditions=react-server --env-file=.env.local scripts/seed/13-pack-chains.ts   (report only)
 *   npx tsx --conditions=react-server --env-file=.env.local scripts/seed/13-pack-chains.ts               (write)
 */
