...
Write-Output ""
Write-Output "# IMPORTANT: AUTH_JWT_SECRET must also be configured in Supabase as an HS256"
Write-Output "# standby key (Dashboard -> JWT Keys -> Create standby key, algorithm HS256)."
