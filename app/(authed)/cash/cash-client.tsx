          ...
          {extraNames.map((name, i) => (
            <div key={i} className="flex items-center gap-2">
              ...
              <button
                ...
                className="inline-flex min-h-[44px] min-w-[44px] shrink-0 items-center justify-center rounded-md border-2 border-co-border-2 bg-co-surface px-2 text-sm font-bold text-co-cta-text transition-colors hover:border-co-cta-text focus:outline-none focus-visible:ring-4 focus-visible:ring-co-gold/60"
              >
                ✕
              </button>
            </div>
