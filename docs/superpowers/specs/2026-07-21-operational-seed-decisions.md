...
### ⏳ Stage 7 — Checklists (LAST STAGE)
Reconcile CO's closing/opening/prep checklists vs the already-seeded templates (don't duplicate). Ground live `checklist_templates`/`checklist_template_items` + the closing-checklist source in `docs/seed/` before authoring.
