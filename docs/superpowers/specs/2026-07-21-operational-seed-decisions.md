...
**⏳ NEXT = Stage 3c Sides** (Antipasto Pasta, Cannoli Cream, Chix Salad→Chicken Salad, Egg Salad, Onion Dip→French Onion Dip, Tuna Salad). Note Chicken Salad's "BH Ever Roast Chicken" input = BH SKU (unseeded → will miss until BH seed). Then BH-SKU seed + Slicing/Veg.
