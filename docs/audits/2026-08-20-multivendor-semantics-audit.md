...
| # | Gap | Effort | Coupling |
|---|---|---|---|
| P1 | Ham + Fresh Mozzarella unorderable — DATA adjudication w/ Juan (pick surviving twin per pair; move par+price+pack+pins together; deactivate loser) | S | none — do first |
