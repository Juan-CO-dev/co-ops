# PHASE HISTORY — the full build chronicle (archived from AGENTS.md, 2026-07-23)

> This file is the verbatim phase-by-phase log that lived in AGENTS.md from Phase 0
> through 2026-07-13. It was archived when AGENTS.md was restructured into a compact
> law-book (the durable rules, extracted and organized by domain) — the 149KB
> chronological log had become "a novella an agent must read to find the RLS naming
> convention" (7-seat council review, 2026-07-23). Nothing here was deleted; every
> durable rule was extracted INTO AGENTS.md with its context pointer back here.
> Read this file when you need the full story behind a rule — the incident, the
> smoke test, the recovery — not for day-to-day authoring.
