...
const OVER_PAR_REASON_VALUES: ReadonlySet<string> = new Set(
 ...
 */
export function isOverParReasonCategory(
  value: string,
): value is OverParReasonCategory {
  return OVER_PAR_REASON_VALUES.has(value);
}
