 ...
 * Leadership section (company-wide MoO+) followed by a 2-col grid of linked
 * teammate tiles. Highlights the viewer's own entry and surfaces MVP-win count.
 */
...
export function ProfileDirectory({
  ...
  if (staff.length === 0 && leadership.length === 0) {
  ...
  return (
    <div>
      {leadership.length > 0 ? (
        <section>
          <p className="mb-2 text-xs font-bold uppercase tracking-wide text-co-text-muted">
            ...
            {leadership.map((e) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="ml-auto rounded-full bg-co-gold/20 px-2 py-0.5 text-[9px] font-bold uppercase text-co-text-dim">
