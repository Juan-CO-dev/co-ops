                            ...
                            >
                              ...
                              {canManage ? (
                                <button
                                  ...
                                  className="ml-0.5 inline-flex h-11 w-11 items-center justify-center rounded-full text-co-text-muted hover:text-co-cta-text focus:outline-none focus-visible:ring-2 focus-visible:ring-co-gold/60 disabled:opacity-50"
                                >
                                  ×
                                </button>
                              ) : null}
