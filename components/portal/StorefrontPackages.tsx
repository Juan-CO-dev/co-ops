    ...
    <>
      ...
      {platters.length > 0 && (
        <section id="platters" className="mx-auto max-w-6xl scroll-mt-16 px-5 py-16">
          <div className="grid grid-cols-1 items-stretch gap-8 lg:grid-cols-2">
            <Reveal className="min-h-[320px] overflow-hidden rounded-3xl bg-co-text/5">
        ...
        <section id="lunch-boxes" className="border-y border-co-border/50 bg-co-surface/40 scroll-mt-16">
          <div className="mx-auto max-w-6xl px-5 py-16">
            <div className="grid grid-cols-1 items-stretch gap-8 lg:grid-cols-2">
              ...
              <Reveal delay={80} className="order-1 min-h-[300px] overflow-hidden rounded-3xl bg-co-text/5 lg:order-2">
      ...
      {bigSubs.length > 0 && (
        <section id="big-subs" className="mx-auto max-w-6xl scroll-mt-16 px-5 py-16">
          <Reveal className="overflow-hidden rounded-[2rem] bg-co-gold">
